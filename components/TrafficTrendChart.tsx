          ...
          <AreaChart data={data} margin={{ top: 5, right: 30, left: 10, bottom: 5 }}>
            ...
            <defs>
              <linearGradient id="trafficColor" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor={theme.chart.areaFillStart} stopOpacity={0.8}/>
                <stop offset="95%" stopColor={theme.chart.areaFillStart} stopOpacity={0}/>
              </linearGradient>
            </defs>
            <Area type="monotone" dataKey="totalTraffic" name="Total Weekly Traffic" stroke={theme.chart.areaStroke} strokeWidth={3} fillOpacity={1} fill="url(#trafficColor)" />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
